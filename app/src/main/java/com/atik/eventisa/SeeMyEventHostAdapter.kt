...
class SeeMyEventHostAdapter(private val SeeMyEventArray:ArrayList<AddEventData>,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SeeMyEventHostAdapter.SeeMyEventViewHolder {
        val itemView: View = LayoutInflater.from(parent.context).
        inflate(R.layout.see_event_host_item,parent,false)
        return (SeeMyEventHostAdapter.SeeMyEventViewHolder(itemView))
    }
    ...
    override fun onBindViewHolder(holder: SeeMyEventViewHolder, position: Int) {
        ...
        Constants.HostUid=dbAuth.uid.toString()
